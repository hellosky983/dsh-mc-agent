...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function LauncherApp(props) {
      ...
      return React.createElement("div", { className: "dshmc" + (appMode === "tab" ? " dshmc-tab" : "") },
        TopBar({
          account: s.account,
          java: s.java,
      ...
      return React.createElement("div", { className: "dshmc-main" },
        React.createElement("div", { className: "dshmc-hero" },
          ...
          !props.account ? React.createElement("div", { className: "dshmc-hint" },
            "Sign in with your Microsoft account to play. Playing Minecraft requires a valid, legitimately purchased account."
          ) : null,
        )
      );
    }
    ...
    exports.apply = function (ctx) {
      ...
      // inside a "Minecraft" tab of the normal DSH chat UI; 'fullscreen' takes
      // over the whole page (root slot, priority -1).
      var settled = false;
      function mount(mode) {
        if (settled) return;
        settled = true;
        appMode = mode === "fullscreen" ? "fullscreen" : "tab";
      ...
      fetch("/api/mc/state")
        ...
        .then(function (s) { mount(s.settings && s.settings.uiMode); })
        .catch(function () { mount("tab"); });
