  ...
  factory: (require) => {
    ...
    function LauncherApp(props) {
      ...
      function onPlay() {
        ...
        if (!s.account) { setModal("login"); pushLocal("Please sign in with your Microsoft account first."); return; }
        setBusy(true);
    ...
    function VersionPicker(props) {
      ...
      return React.createElement("select", {
        ...
        installed.length ? React.createElement("optgroup", { label: "Installed" }, opts(installed)) : null,
        React.createElement("optgroup", { label: "Release" }, opts(release)),
        React.createElement("optgroup", { label: "Snapshot" }, opts(snapshot)),
    ...
    function MainPanel(props) {
      ...
      var loginBanner = !props.account ? React.createElement("div", { className: "dshmc-login-banner" },
        React.createElement("div", { className: "msg" },
          React.createElement("b", null, "Sign in required."),
          " Playing Minecraft requires a valid, legitimately purchased Microsoft account. Sign in to install and launch."
        ),
        React.createElement("button", { className: "btn", onClick: props.onLogin }, "Sign in")
      ) : null;
      ...
      return React.createElement("div", { className: "dshmc-main" },
        React.createElement("div", { className: "dshmc-hero" },
          React.createElement("div", { className: "dshmc-hero-sub" }, "Select version"),
    ...
    function LoginModal(props) {
      var modeState = React.useState("oauth");
      ...
      return React.createElement("div", { className: "dshmc-modal" },
        React.createElement("div", { className: "dshmc-modal-card" },
          ...
          phase === "idle" ? React.createElement("div", null,
            React.createElement("div", { className: "dshmc-hint" },
              "Sign in with the Microsoft account that owns Minecraft Java Edition. You will be redirected to Microsoft\u2019s login page, then brought back automatically."
            ),
            React.createElement("div", { className: "dshmc-modal-row", style: { flexDirection: "column", gap: 10, alignItems: "stretch" } },
              React.createElement("button", { className: "dshmc-btn green", style: { padding: "12px" }, onClick: startOauth }, "\u21bb Sign in in your browser (recommended)"),
              React.createElement("button", { className: "dshmc-btn", style: { padding: "10px" }, onClick: function () { setMode("device"); startDevice(); } }, "Use a device code instead"),
          ...
          phase === "wait" && mode === "oauth" ? React.createElement("div", { className: "dshmc-hint" },
            "A Microsoft sign-in page should have opened in a new tab. Complete the sign-in there \u2014 this window will update automatically when done."
          ) : null,
          phase === "wait" && mode === "device" && info ? React.createElement("div", null,
            React.createElement("div", { className: "dshmc-hint" },
          ...
          phase !== "idle" ? React.createElement("div", { className: "dshmc-modal-row" },
    ...
    function SettingsModal(props) {
      ...
      return React.createElement("div", { className: "dshmc-modal" },
        React.createElement("div", { className: "dshmc-modal-card" },
          ...
          React.createElement("div", { className: "dshmc-field" },
            React.createElement("label", null, "Interface mode (restart to apply)"),
          ...
          React.createElement("div", { className: "dshmc-field" },
            React.createElement("label", null, "Show Minecraft tab in the session"),
