  ...
  factory: (require) => {
    ...
    function LauncherApp(props) {
      ...
      function onPlay() {
        ...
        if (!s.account && !(s.settings && s.settings.offlineMode)) { setModal("login"); pushLocal("\u8bf7\u5148\u767b\u5f55\u6216\u5f00\u542f\u79bb\u7ebf\u6a21\u5f0f\u3002"); return; }
        setBusy(true);
        ...
        modal === "login" ? React.createElement(LoginModal, {
          ...
          onOffline: function () {
            api("/settings", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ offlineMode: true }) })
              .then(function () { setModal(null); pushLocal("\u5df2\u5f00\u542f\u79bb\u7ebf\u6a21\u5f0f\uff08\u4ec5\u9650\u5df2\u8d2d\u6b63\u7248\u73a9\u5bb6\uff09\u3002"); })
              .catch(function (e) { pushLocal("Error: " + e.message); });
          },
        }) : null,
    ...
    function OnboardModal(props) {
      ...
      var steps = [
        { t: "\u6b22\u8fce\u4f7f\u7528 DSH Minecraft \u542f\u52a8\u5668\uff01", d: "\u8fd9\u662f\u4e00\u4e2a\u57fa\u4e8e DeepSeek Harness \u7684\u975e\u5b98\u65b9\u542f\u52a8\u5668\u3002\u4e0b\u9762\u4e09\u6b65\u5373\u53ef\u5f00\u59cb\u6e38\u73a9\u3002\u4f60\u4e5f\u53ef\u4ee5\u5728\u5de6\u4fa7\u804a\u5929\u91cc\u8ba9 AI \u7528 mc_* \u5de5\u5177\u5e2e\u4f60\u64cd\u4f5c\u3002" },
        { t: "\u2460 \u914d\u7f6e Azure client id\uff08\u767b\u5f55\u5fc5\u9700\uff09", d: "\u6253\u5f00 \u8bbe\u7f6e \u2192 Microsoft client id\uff0c\u586b\u5165\u4f60\u81ea\u5df1\u5728 portal.azure.com \u6ce8\u518c\u7684\u5e94\u7528 ID\uff08\u52fe\u9009 \u201cAllow public client flows\u201d\uff09\u3002\u8be6\u89c1 README\u3002" },
      ...
      return React.createElement("div", { className: "dshmc-modal" },
        React.createElement("div", { className: "dshmc-modal-card" },
          ...
          React.createElement("div", { className: "dshmc-hint", style: { minHeight: 60 } }, s.d),
    ...
    function MainPanel(props) {
      ...
      var loginBanner = !props.account && !props.offlineMode ? React.createElement("div", { className: "dshmc-login-banner" },
    ...
    function LoginModal(props) {
      ...
      return React.createElement("div", { className: "dshmc-modal" },
        React.createElement("div", { className: "dshmc-modal-card" },
          ...
          React.createElement("div", { className: "dshmc-hint", style: { borderTop: "1px solid rgba(255,255,255,.1)", paddingTop: 12, marginTop: 4 } },
            React.createElement("b", null, "\u6ca1\u6709\u5fae\u8f6f\u8d26\u53f7\u6216\u4e0d\u60f3\u914d\u7f6e\uff1f"),
            " \u53ef\u4ee5\u7528\u201c\u79bb\u7ebf\u6a21\u5f0f\u201d\u4e0d\u767b\u5f55\u76f4\u63a5\u73a9\uff08\u4ec5\u9650\u5df2\u8d2d\u4e70\u6b63\u7248\u7684\u73a9\u5bb6\uff0c\u65e0\u6cd5\u8fdb\u5728\u7ebf\u670d\u52a1\u5668\uff09\u3002"
          ),
          React.createElement("div", { className: "dshmc-modal-row", style: { justifyContent: "space-between" } },
            React.createElement("button", { className: "dshmc-btn", onClick: props.onOffline }, "\u79bb\u7ebf\u6a21\u5f0f\u73a9"),
      ...
      return React.createElement("div", { className: "dshmc-modal" },
        React.createElement("div", { className: "dshmc-modal-card" },
          ...
          React.createElement("div", { className: "dshmc-field" },
            ...
            React.createElement("div", { className: "dshmc-hint" }, "微软登录的 Azure 应用 ID；在 portal.azure.com 注册（勾选 Allow public client flows）。")
          ),
          React.createElement("div", { className: "dshmc-field" },
            React.createElement("label", null, "离线模式（可选）"),
            React.createElement("div", { style: { display: "flex", gap: 10, alignItems: "center" } },
              React.createElement("label", { style: { display: "flex", gap: 6, alignItems: "center", cursor: "pointer" } },
                ...
                React.createElement("span", { style: { fontSize: 13, color: "#e8e8e8" } }, "不登录直接玩（傻瓜式）")
              ),
              React.createElement("input", {
                value: f.offlineName || "",
                onChange: upd("offlineName"),
                placeholder: "玩家名",
                style: { flex: 1, minWidth: 120, background: "rgba(0,0,0,.4)", border: "1px solid rgba(255,255,255,.18)", color: "#fff", borderRadius: 8, padding: "9px 12px", fontSize: 13, outline: "none" },
              })
            ),
            React.createElement("div", { className: "dshmc-hint" }, "\u26a0\ufe0f 离线模式仅限已购买 Minecraft 正版的玩家离线使用；离线无法进入在线服务器/领域。")
          ),
          React.createElement("div", { className: "dshmc-field" },
